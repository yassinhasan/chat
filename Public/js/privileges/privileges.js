    ...
    for(let result of results)
    {
        trTag += `
            <tr>
                ...
                <td>
                    ${result['privilegesTilte']}
                </td>
                <td>
                    ${result['privilegesUrl']}
                </td>
                <td class='action'>
                <button data-href="/chat/privileges/edit/${result['privilegesId']}" class="btn btn-primary btn-sm edit "><i class="fas fa-edit"></i></button>
                <button data-href="/chat/privileges/delete/${result['privilegesId']}" class="btn btn-danger btn-sm delete"><i class="fas fa-times"></i></button>
                </td>
            </tr>
        `;
    }
